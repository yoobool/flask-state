    ...
    class MachineStatus {
        ...
        initFlaskStateContainer() {
            let str = '<div class="flask-state-elem layer console-info-back-style" id="fs-info-back" disabled="disabled" xmlns="http://www.w3.org/1999/html">' +
                ...
                '<div class="flask-state-elem fs-select-container"><img class="fs-select-arrow" src="/static/nav-bottom.png"/><select id="fs-select-days" class="margin-right-5 fs-select-days">' +
                ...
                '<button type="button" class="flask-state-elem console-info-close-style" id="fs-info-close"><img src="/static/times.svg" /></button>' +
